                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= ($produto['controlar_estoque'] == 1) ? "Sim" : "Não" ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Qtd</label>
                                    <input type="text" class="form-control" value="<?= ($produto['controlar_estoque'] == 1) ? $produto['quantidade'] : "--" ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Qtd mínima</label>
                                    <input type="text" class="form-control" value="<?= ($produto['controlar_estoque'] == 1) ? $produto['quantidade_minima'] : "--" ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <?php if (!empty($codigos_de_barras)) : ?>
                                        <?php foreach ($codigos_de_barras as $codigo) : ?>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?= $codigo['codigo_de_barra'] ?>" disabled="">
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="SEM GTIN" disabled="">
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $produto['porcentagem_icms'] ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">PIS/COFINS</label>
                                    <input type="text" class="form-control" value="<?= $produto['pis_cofins'] ?>" disabled>
                                </div>
                            </div>
