                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="input-razao-social" name="nome_da_empresa" value="<?= (isset($fornecedor)) ? $fornecedor['nome_da_empresa'] : "" ?>" onkeyup="verificaNomeCampoGeral('nome_da_empresa')" required="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Nome do Representante</label>
                                    <input type="text" class="form-control" name="nome_do_representante" value="<?= (isset($fornecedor)) ? $fornecedor['nome_do_representante'] : "" ?>" onkeyup="verificaNomeCampoGeral('nome_do_representante')" required="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">CNPJ</label>
                                    <input type="text" class="form-control cnpj" id="CNPJ" name="cnpj" onblur="validarCNPJ('CNPJ')" value="<?= (isset($fornecedor)) ? $fornecedor['cnpj'] : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="isento" name="isento" style="width: 100%" onchange="alteraIsento()">
                                        <?php if (isset($fornecedor) && $fornecedor['ie'] == "") : ?>
                            ...
                            <div class="col-lg-4" style="">
                                <div class="form-group">
                                    <label for="">I.E.</label>
                                    <input type="text" class="form-control" id="input-ie" name="ie" value="<?= (isset($fornecedor)) ? $fornecedor['ie'] : "" ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
