...
<div class="modal fade" id="modal-adicionar-desconto">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Adicionar Desconto</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="/food/adicionarDesconto" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="">Valor</label>
                                <input type="text" class="form-control money" name="valor" value="" required>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="">Valor</label>
                                <input type="text" class="form-control money" id="valor_pgto" name="valor" value="" required>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group">
...
<!-- Modal Alterar quantidade do produto da mesa -->
<div class="modal fade" id="modal-alterar-quantidade-do-produto-da-mesa">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Alterar Qtd. Produto</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="/food/alteraQuantidadeDoProdutoDaMesa/<?= $id_mesa ?>" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <input type="hidden" id="aux_id_produto_provisorio" name="id_produto_provisorio">

                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <p><b>Atenção:</b> Caso queira remover o produto insera 0 (zero) na quantidade.</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <button class="btn btn-info" data-toggle="modal" data-target="#modal-adicionar-pagamento" <?= ($valor_total == 0) ? "disabled" : "" ?>>Efetuar Pagamento</button>
                                    <button class="btn btn-success" data-toggle="modal" data-target="#modal-finalizar-mesa" <?= ($valor_pago < ($valor_total - $desconto)) ? "disabled" : "" ?> <?= ($valor_pago == 0 && $valor_total == 0) ? "disabled" : "" ?>>Finalizar Mesa</button>
                                </div>
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <button type="button" class="btn btn-default style-action" data-toggle="modal" data-target="#modal-adicionar-desconto">Adicionar desconto</button>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    Valor Total: <br>
                                                    <?= (isset($valor_total)) ? number_format($valor_total, 2, ',', '.') : "R$ 0,00" ?>
                                                </td>
                                                <td>
                                                    Desconto: <br>
                                                ...
                                                <td>
                                                    Valor Final: <br>
                                                    <?= number_format($valor_total - $desconto, 2, ',', '.') ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    Valor Pago: <br>
                                                    <?= (isset($valor_pago)) ? number_format($valor_pago, 2, ',', '.') : "R$ 0,00" ?>
                                                </td>
                                                <td>
                                                    Restante: <br>
                                                    <?php if (($valor_total - $desconto) > $valor_pago) : ?>
                                                        <?= number_format((($valor_total - $desconto) - $valor_pago), 2, ',', '.') ?>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    Troco: <br>
                                                    <?php if ($valor_pago > ($valor_total - $desconto)) : ?>
                                                        <?= number_format(($valor_pago - ($valor_total - $desconto)), 2, ',', '.') ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" style="text-align: right">
                                    <button type="button" class="btn btn-info style-action" onclick="mandarTodosOsProdutosPraCozinha()"><i class="fas fa-utensils" aria-hidden="true"></i> Mandar todos pra cozinha</button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <?php if (!empty($produtos_da_mesa)) : ?>
                                        <?php foreach ($produtos_da_mesa as $produto) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success style-action" onclick="pegaDadosDoProduto(<?= $produto['id_produto_provisorio'] ?>, <?= $produto['quantidade'] * $produto['valor'] ?>, 'PGTO do Prod. <?= $produto['nome'] ?>')" data-toggle="modal" data-target="#modal-adiciona-pagamento-do-produto"><i class="fas fa-dollar-sign" aria-hidden="true"></i></button>
                                                    <button type="button" class="btn btn-info style-action" onclick="mandarPraCozinha(<?= $produto['id_produto_provisorio'] ?>)"><i class="fas fa-utensils" aria-hidden="true"></i></button>
                                                    <button type="button" class="btn btn-warning style-action" onclick="document.getElementById('aux_id_produto_provisorio').value = <?= $produto['id_produto_provisorio'] ?>" data-toggle="modal" data-target="#modal-alterar-quantidade-do-produto-da-mesa"><i class="fas fa-edit"></i></button>
                                                </td>
                                            </tr>
...
<script>
    ...
    function mandarPraCozinha(id_produto_provisorio) {
        if (confirm("Mandar produto pra cozinha? Essa ação mudará o status do produto.")) {
            window.location.href = "/food/mandarProdutoPraCozinha/" + id_produto_provisorio + "/<?= $id_mesa ?>";
        }
    }

    function mandarTodosOsProdutosPraCozinha() {
        if (confirm("Mandar todos os produto pra cozinha? Essa ação mudará os status dos produtos.")) {
            window.location.href = "/food/mandarTodosOsProdutosPraCozinha/" + "/<?= $id_mesa ?>";
        }
    }
</script>
