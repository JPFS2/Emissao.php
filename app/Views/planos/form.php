                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <a href="/planos" class="btn btn-success button-voltar"><i class="fa fa-arrow-alt-circle-left"></i> Voltar</a>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome" value="<?= (isset($plano)) ? $plano['nome'] : "" ?>" required="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Valor</label>
                                    <input type="text" class="form-control money" name="valor" value="<?= (isset($plano)) ? number_format($plano['valor'], 2, ',', '.') : "" ?>" required="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Duração</label>
                                    <input type="text" class="form-control" name="duracao" value="<?= (isset($plano)) ? $plano['duracao'] : "" ?>" placeholder="Em dias Ex: 30" required="">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Observações</label>
                                    <textarea class="form-control" rows="5" name="observacoes"><?= (isset($plano)) ? $plano['observacoes'] : "" ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="venda_rapida" name="venda_rapida" style="width: 100%">
                                            <?php if (isset($controle_de_acesso_do_plano)) : ?>
                            ...
                            <div class="col-lg-3" style="border: 1px solid lightgrey;">
                                <label style="margin-top: 10px">ORDEM DE SERVIÇO E LABORATÓRIO</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="laboratorio" name="laboratorio" style="width: 100%">
                                            <?php if (isset($controle_de_acesso_do_plano)) : ?>

                                                <?php if ($controle_de_acesso_do_plano['laboratorio'] == 1) : ?>
                                                    <option value="1" selected>Sim</option>
                                                    <option value="0">Não</option>
                                                <?php else : ?>
                                                    <option value="1">Sim</option>
                            ...
                            <div class="col-lg-3" style="border: 1px solid lightgrey;">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 style="text-align: center"> >> <b>VENDAS</b>
                                            << </h6>
                                                <hr>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 style="text-align: center"> >> <b>ESTOQUE</b>
                                            << </h6>
                                                <hr>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 style="text-align: center"> >> <b>FINANCEIRO</b>
                                            << </h6>
                                                <hr>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 style="text-align: center"> >> <b>GERAL</b>
                                            << </h6>
                                                <hr>
                                    </div>
                                </div>
                        ...
                        <div class="row" style="margin-top: 25px">
                            <div class="col-lg-6">
                                <p><b>Atenção:</b> Ao fazer alterações no plano, todas os usuários das empresas e usuários cadastrados pelas empresas que estão vinculadas a esse plano sofrerão alterações no controle de acesso.</p>
                            </div>
                        </div>

                    </div>

                    <?php if (isset($plano) && isset($controle_de_acesso_do_plano)) : ?>
                        <input type="hidden" name="id_plano" value="<?= $plano['id_plano'] ?>">
                        <input type="hidden" name="id_controle_de_acesso" value="<?= $controle_de_acesso_do_plano['id_controle_de_acesso'] ?>">
                    <?php endif; ?>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-lg-12" style="text-align: right">
                                <button type="submit" class="btn btn-primary"><?= (isset($plano)) ? "Atualizar" : "Cadastrar" ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function DesabilitaModuloControleGeral() {
        if (document.getElementById('modulo_controle_geral').checked) {
            ...
            document.getElementById('transportadoras').disabled = false;
            ...
            document.getElementById('transportadoras').disabled = true;
        }
    }
    ...
    function DesabilitaModuloRelatorios() {
        if (document.getElementById('modulo_relatorios').checked) {
            ...
            document.getElementById('vendas_lucro_total').disabled = false;
            ...
            document.getElementById('vendas_lucro_total').disabled = true;
    ...
    <?php if (isset($controle_de_acesso_do_plano)) : ?>
        ...
        <?php if (
            ...
            $controle_de_acesso_do_plano['pdv'] == 0 &&
        ...
        <?php if (
            ...
            $controle_de_acesso_do_plano['laboratorio'] == 0
        ) : ?>
        ...
        <?php if (
            ...
            $controle_de_acesso_do_plano['transportadoras'] == 0
        ) : ?>
        ...
        <?php if (
            ...
            $controle_de_acesso_do_plano['nfce'] == 0
        ) : ?>
