                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="tema" style="width: 100%">
                                        <option value="1" <?= ($configuracao['tema'] == 1) ? "selected" : "" ?>>Dark</option>
                                        <option value="2" <?= ($configuracao['tema'] == 2) ? "selected" : "" ?>>Light</option>
                                        <option value="3" <?= ($configuracao['tema'] == 3) ? "selected" : "" ?>>Dark Level One</option>
                                        <option value="4" <?= ($configuracao['tema'] == 4) ? "selected" : "" ?>>Light Level One</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
