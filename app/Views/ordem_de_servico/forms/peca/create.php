                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control money" name="valor" value="<?= number_format($produto['valor_de_venda'], 2, ',', '.') ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="subtotal" value="<?= number_format(($produto['quantidade'] * $produto['valor_de_venda']), 2, ',', '.') ?>" disabled>
                                </div>
                            </div>
