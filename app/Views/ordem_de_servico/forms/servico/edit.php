                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="detalhes" value="<?= $servico['detalhes'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control money" name="desconto" value="<?= number_format($servico['desconto'], 2, ',', '.') ?>" required>
                                </div>
                            </div>
