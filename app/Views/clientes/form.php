                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control cnpj" id="CNPJ" name="cnpj" onblur="validarCNPJ('CNPJ')" value="<?= (isset($cliente)) ? $cliente['cnpj'] : "" ?>" required="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Razão social</label>
                                    <input type="text" class="form-control" id="input-razao-social" name="razao_social" onkeyup="verificaNomeCampoGeral('razao_social')" value="<?= (isset($cliente)) ? $cliente['razao_social'] : "" ?>" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
