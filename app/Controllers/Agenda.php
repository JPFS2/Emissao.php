...
class Agenda extends Controller
{
    ...
    public function store()
    {
        ...
        if(isset($dados['id_compromisso'])) :
            ...
            return redirect()->to(base_url("agenda/edit/{$dados['id_compromisso']}"));
        endif;
        ...
        return redirect()->to(base_url("agenda?data={$dados['data']}"));
    }
    ...
    public function delete($id_compromisso, $data)
    {
        ...
        return redirect()->to(base_url("agenda?data={$data}"));
    }
}
