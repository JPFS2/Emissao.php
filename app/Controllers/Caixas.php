...
class Caixas extends Controller
{
    ...
    public function fechar($id_caixa)
    {
        ...
        // Adiciona ao array
        $dados['data_de_fechamento'] = date('Y-m-d');
        $dados['hora_de_fechamento'] = date('H:i:s');
        ...
        return redirect()->to(base_url("caixas/show/$id_caixa"));
    }
    ...
    public function store()
    {
        ...
        if(isset($dados['id_caixa'])) :
            ...
            return redirect()->to(base_url("caixas/show/{$dados['id_caixa']}"));
        endif;
        ...
        return redirect()->to(base_url('caixas'));
    }
